...
const tours: Tour[] = [
  {
    ...
    reviewCount: 127,
    images: [
      "/placeholder.svg?height=600&width=1200&text=Gorilla+Trekking+Hero",
      "/placeholder.svg?height=400&width=600&text=Mountain+Gorillas",
      "/placeholder.svg?height=400&width=600&text=Forest+Trail",
      "/placeholder.svg?height=400&width=600&text=Gorilla+Family",
      "/placeholder.svg?height=400&width=600&text=Bwindi+Forest",
      "/placeholder.svg?height=400&width=600&text=Local+Community",
    ],
  ...
  },
  {
    ...
    reviewCount: 89,
    images: [
      "/placeholder.svg?height=600&width=1200&text=Murchison+Falls+Hero",
      "/placeholder.svg?height=400&width=600&text=Murchison+Falls",
      "/placeholder.svg?height=400&width=600&text=Game+Drive",
      "/placeholder.svg?height=400&width=600&text=Boat+Safari",
      "/placeholder.svg?height=400&width=600&text=Wildlife+Viewing",
      "/placeholder.svg?height=400&width=600&text=Nile+River",
    ],
  ...
  },
  {
    ...
    reviewCount: 156,
    images: [
      "/placeholder.svg?height=600&width=1200&text=Queen+Elizabeth+Hero",
      "/placeholder.svg?height=400&width=600&text=Tree+Climbing+Lions",
      "/placeholder.svg?height=400&width=600&text=Kazinga+Channel",
      "/placeholder.svg?height=400&width=600&text=Crater+Lakes",
      "/placeholder.svg?height=400&width=600&text=Chimpanzee+Tracking",
      "/placeholder.svg?height=400&width=600&text=Wildlife+Safari",
    ],
...
const blogPosts: BlogPost[] = [
  {
    ...
    image: "/placeholder.svg?height=400&width=800&text=Gorilla+Trekking+Guide",
    readTime: 8,
    featured: true,
  },
  {
    ...
    author: "Michael Chen",
    authorImage: "/placeholder.svg?height=100&width=100&text=Michael",
    publishedAt: "2024-03-10",
    category: "Travel Tips",
    tags: ["safari", "seasons", "planning", "wildlife"],
    image: "/placeholder.svg?height=400&width=800&text=Uganda+Safari+Seasons",
    readTime: 6,
    featured: false,
  },
  {
    ...
    authorImage: "/placeholder.svg?height=100&width=100&text=Emma",
    publishedAt: "2024-03-05",
    category: "Culture",
    tags: ["culture", "traditions", "community", "heritage"],
    image: "/placeholder.svg?height=400&width=800&text=Uganda+Culture",
    readTime: 7,
    featured: true,
  },
]
...
const galleryImages: GalleryImage[] = [
  {
    id: "1",
    url: "/placeholder.svg?height=600&width=800&text=Mountain+Gorilla",
    title: "Mountain Gorilla Family",
    description: "A silverback gorilla with his family in Bwindi Impenetrable Forest",
    category: "Wildlife",
    location: "Bwindi Forest",
    photographer: "John Safari",
    tags: ["gorillas", "wildlife", "family"],
  },
  {
    id: "2",
    url: "/placeholder.svg?height=600&width=800&text=Murchison+Falls",
    title: "Murchison Falls",
    description: "The powerful Murchison Falls where the Nile squeezes through a narrow gorge",
    category: "Landscapes",
    location: "Murchison Falls NP",
    photographer: "Jane Explorer",
    tags: ["waterfalls", "nile", "landscape"],
  },
  {
    id: "3",
    url: "/placeholder.svg?height=600&width=800&text=Tree+Climbing+Lion",
    title: "Tree-Climbing Lion",
    description: "A lion resting in a fig tree in Ishasha sector of Queen Elizabeth National Park",
    category: "Wildlife",
    location: "Queen Elizabeth NP",
    photographer: "Mike Wildlife",
    tags: ["lions", "trees", "unique"],
  },
]
