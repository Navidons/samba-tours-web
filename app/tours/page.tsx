  ...
  return (
    <TourComparisonProvider>
      <div className="bg-gray-50 min-h-screen">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-orange-600 via-red-600 to-orange-700 text-white py-32 overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20"
            style={{ 
              backgroundImage: 'url("/photos/murchison-falls-spectacular.jpg")'
            }}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-orange-600/90 via-red-600/90 to-orange-700/90"></div>
          <div className="relative max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-orange-100">
              From gorilla encounters to savannah adventures, explore our curated collection of unforgettable journeys through the Pearl of Africa.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button 
                variant="outline" 
                className="bg-white/10 border-white/30 text-white hover:bg-white hover:text-orange-600 transition-all duration-300"
