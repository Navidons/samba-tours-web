      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              size="lg"
              className="bg-white hover:bg-gray-100 text-orange-600 px-8 py-4 font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              asChild
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-colors duration-300">
              ...
              <p className="text-orange-200">+256 700 123 456</p>
            </div>
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-colors duration-300">
              <Mail className="h-8 w-8 mx-auto mb-3 text-orange-200" />
              <h3 className="font-semibold mb-2">Email Us</h3>
              <p className="text-orange-200">info@sambatours.com</p>
            </div>
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-colors duration-300">
              <MessageCircle className="h-8 w-8 mx-auto mb-3 text-orange-200" />
              <h3 className="font-semibold mb-2">WhatsApp</h3>
              <p className="text-orange-200">Quick Response</p>
            </div>
          </div>
        </div>
      </div>
