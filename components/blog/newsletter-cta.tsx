...
export default function NewsletterCTA() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-orange-600 via-red-600 to-orange-700">
      <div className="container-max">
        <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl">
          <div className="p-8 md:p-12 text-center">
            ...
            <h2 className="font-playfair text-4xl font-bold text-earth-900 mb-4">Never Miss an Adventure</h2>
            ...
            <form className="max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                ...
                <Button
                  type="submit"
                  className="h-12 px-8 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-base"
                >
              ...
              <p className="text-sm text-earth-500 mt-4">Join 5,000+ travelers who trust us. Unsubscribe anytime.</p>
            </form>

            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 mt-8 text-sm text-earth-600">
